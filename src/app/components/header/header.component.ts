  ...
  ngOnInit() {
    ...
    this.router.events.subscribe(event => {
      if (event instanceof NavigationStart) {
        ...
        if (
          arr[1] == "visa-requirements" || arr[1] == "freeVisa" || arr[1] == "visaOnArrival" || arr[1] == "profile" || arr[1] == "myBookings" || arr[1] == "bookingDetail" || arr[1] == "addTraveller" || event.url == "/sim/checkout" || arr[1] == "slcontainer" || arr[1] == "tnc" || arr[1] == "privacyPolicy" || arr[1] == "cookiePolicy" || arr[1] == "cookiePolicy"       ) {
