...
@Component({
  selector: 'app-requirement-vietnam',
  templateUrl: './requirement-vietnam.component.html',
  styleUrls: ['./requirement-vietnam.component.css'],
  animations: [
...
export class RequirementVietnamComponent implements OnInit, AfterViewInit {
  ...
  visaType: string;
  public selectedCountrytype = "Vietnam";
