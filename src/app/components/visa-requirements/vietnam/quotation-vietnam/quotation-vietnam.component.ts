...
@Component({
  selector: 'app-quotation-vietnam',
  templateUrl: './quotation-vietnam.component.html',
  styleUrls: ['./quotation-vietnam.component.css']
})
export class QuotationVietnamComponent implements OnInit {
