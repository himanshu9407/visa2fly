...
@Component({
  selector: 'app-requirement-antigua',
  templateUrl: './requirement-antigua.component.html',
  styleUrls: ['./requirement-antigua.component.css'],
  animations: [
...
export class RequirementAntiguaComponent implements OnInit {
