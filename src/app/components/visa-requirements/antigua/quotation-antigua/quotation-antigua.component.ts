...
@Component({
  selector: 'app-quotation-antigua',
  templateUrl: './quotation-antigua.component.html',
  styleUrls: ['./quotation-antigua.component.css']
})
export class QuotationAntiguaComponent implements OnInit {
