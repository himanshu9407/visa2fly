...
export class KenyaComponent implements OnInit {
  ...
  public selectedCountrytype = "Kenya";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Kenya Visa | Apply For Kenya Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for Kenya e-visa, Kenya tourist visa application, Kenya Visa, Kenya tourist visa for indian, apply for Kenya e visa, Kenya e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Kenya visa for Indians. Indian passport holders can easily apply for an Kenya visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Kenya visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Kenya.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/kenya-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/kenya-visa-online");
  }
