...
export class DenmarkComponent implements OnInit {
  ...
  public selectedCountrytype = "Denmark";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Denmark Visa | Apply For Denmark Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for Denmark e-visa, Denmark tourist visa application, Denmark Visa, Denmark tourist visa for indian, apply for Denmark e visa, Denmark e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Denmark visa for Indians. Indian passport holders can easily apply for an Denmark visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Denmark visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Denmark.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/denmark-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/denmark-visa-online");
  }
