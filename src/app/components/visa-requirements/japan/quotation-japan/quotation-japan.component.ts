...
@Component({
  selector: 'app-quotation-japan',
  templateUrl: './quotation-japan.component.html',
  styleUrls: ['./quotation-japan.component.css']
})
export class QuotationJapanComponent implements OnInit {
