...
export class JapanComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      { name:"keywords", content:"apply for japan e-visa, japan tourist visa application, japan tourist visa for indian, apply for japan e visa, japan e-visa for indians" },
      {
        name: "description",
        content: "Planning to visit Japan? Apply your japan e-visa online at Visa2Fly to make experience a hassle-free and convenient experience. Visa2Fly offers a swifter visa process with additional benefits like travel insurance and travel sim cards. Know more."
      }
    ]);
    ...
    link.setAttribute("href", "https://visa2fly.com/visa-requirements/apply-for-Japan-visa-online");
  }
