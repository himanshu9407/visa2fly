...
export class CanadaComponent implements OnInit {
  ...
  public selectedCountrytype = "Canada";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Canada Visa | Apply For Canada Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for canada e-visa, canada tourist visa application, Canada Visa, canada tourist visa for indian, apply for canada e visa, canada e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Canada visa for Indians. Indian passport holders can easily apply for an Canada visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Canada visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Canada.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/canada-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/canada-visa-online");
  }
