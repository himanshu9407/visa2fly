...
export class RussiaComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      {
        name: "description",
        content: "Planning to visit Russia? Apply your Russia e-visa online at Visa2Fly to make experience a hassle-free and convenient experience. Visa2Fly offers a swifter visa process with additional benefits like travel insurance and travel sim cards. Know more."
      }
    ]);
    ...
    link.setAttribute("href", "https://visa2fly.com/visa-requirements/apply-for-Russia-visa-online");
}
