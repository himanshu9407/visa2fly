...
@Component({
  selector: 'app-quotation-russia',
  templateUrl: './quotation-russia.component.html',
  styleUrls: ['./quotation-russia.component.css']
})
export class QuotationRussiaComponent implements OnInit {
