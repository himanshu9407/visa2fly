...
@Component({
  ...
  styleUrls: ['./taiwan.component.css'],
  animations: [
...
export class TaiwanComponent implements OnInit, AfterViewInit {
  ...
  public selectedCountrytype = "Taiwan";
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      property: "og:title",
      content:
        "Taiwan Visa | Apply For Taiwan Visa Online for Indians- Visa2Fly",
    });
    this.meta.updateTag({ property: "type", content: "website" });
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Taiwan.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
