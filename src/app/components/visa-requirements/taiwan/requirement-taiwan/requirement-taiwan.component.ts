...
@Component({
  selector: 'app-requirement-taiwan',
  templateUrl: './requirement-taiwan.component.html',
  styleUrls: ['./requirement-taiwan.component.css'],
  animations: [
...
export class RequirementTaiwanComponent implements OnInit {
