...
@Component({
  selector: 'app-quotation-taiwan',
  templateUrl: './quotation-taiwan.component.html',
  styleUrls: ['./quotation-taiwan.component.css']
})
export class QuotationTaiwanComponent implements OnInit {
