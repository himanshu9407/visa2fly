...
@Component({
  selector: 'app-quotation-rwanda',
  templateUrl: './quotation-rwanda.component.html',
  styleUrls: ['./quotation-rwanda.component.css']
})
export class QuotationRwandaComponent implements OnInit {
