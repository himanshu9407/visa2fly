...
@Component({
  selector: 'app-requirement-rwanda',
  templateUrl: './requirement-rwanda.component.html',
  styleUrls: ['./requirement-rwanda.component.css'],
  animations: [
...
export class RequirementRwandaComponent implements OnInit {
