...
export class RwandaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/rwanda-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/rwanda-visa-online");
  }
