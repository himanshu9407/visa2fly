...
export class RwandaComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      { name:"keywords", content:"apply for rwanda e-visa, rwanda tourist visa application, rwanda tourist visa for indian, apply for rwanda e visa, rwanda e-visa for indians" },
      {
        name: "description",
        content: "Planning to visit Rwanda? Apply your rwanda e-visa online at Visa2Fly to make experience a hassle-free and convenient experience. Visa2Fly offers a swifter visa process with additional benefits like travel insurance and travel sim cards. Know more."
      }
    ]);
    ...
    link.setAttribute("href", "https://visa2fly.com/visa-requirements/apply-for-Rwanda-visa-online");
  }
