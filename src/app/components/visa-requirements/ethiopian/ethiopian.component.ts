...
export class EthiopianComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Ethiopia.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/ethiopia-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/ethiopia-visa-online");
  }
