...
@Component({
  selector: 'app-quotation-uae',
  templateUrl: './quotation-uae.component.html',
  styleUrls: ['./quotation-uae.component.css']
})
export class QuotationUaeComponent implements OnInit {
