...
@Component({
  selector: 'app-quotation-turkey',
  templateUrl: './quotation-turkey.component.html',
  styleUrls: ['./quotation-turkey.component.css']
})
export class QuotationTurkeyComponent implements OnInit {
