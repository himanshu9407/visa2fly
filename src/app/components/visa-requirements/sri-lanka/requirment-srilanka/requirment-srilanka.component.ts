...
@Component({
  selector: "app-requirment-srilanka",
  templateUrl: "./requirment-srilanka.component.html",
  styleUrls: ["./requirment-srilanka.component.css"],
  animations: [
...
export class RequirmentSrilankaComponent implements OnInit, AfterViewInit {
