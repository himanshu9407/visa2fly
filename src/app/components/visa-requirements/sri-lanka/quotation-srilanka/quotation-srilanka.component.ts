...
@Component({
  selector: 'app-quotation-srilanka',
  templateUrl: './quotation-srilanka.component.html',
  styleUrls: ['./quotation-srilanka.component.css']
})
export class QuotationSrilankaComponent implements OnInit {
  @Input() quotation;
