...
@Component({
  selector: 'app-requirement-afghanistan',
  templateUrl: './requirement-afghanistan.component.html',
  styleUrls: ['./requirement-afghanistan.component.css'],
  animations: [
...
export class RequirementAfghanistanComponent implements OnInit, AfterViewInit {
