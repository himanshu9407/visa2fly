...
export class AfghanistanComponent implements OnInit {
  ...
  public selectedCountrytype = "Afghanistan";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Afghanistan Visa | Apply For Afghanistan Visa Online for Indians- Visa2Fly"
    );
    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for afghanistan e-visa, afghanistan tourist visa application, afghanistan tourist visa for indian, apply for afghanistan e visa, afghanistan e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Planning to visit Afghanistan? Apply your Afghanistan e-visa online at Visa2Fly to make experience a hassle-free and convenient experience. Visa2Fly offers a swifter visa process with additional benefits like travel insurance and travel sim cards. Know more.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Afghanistan.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
