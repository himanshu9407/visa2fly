...
@Component({
  selector: 'app-quotation-afghanistan',
  templateUrl: './quotation-afghanistan.component.html',
  styleUrls: ['./quotation-afghanistan.component.css']
})
export class QuotationAfghanistanComponent implements OnInit {
