...
export class IraqComponent implements OnInit {
  ...
  public selectedCountrytype = "Iraq";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Iraq Visa | Apply For Iraq Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for Iraq e-visa, Iraq tourist visa application, Iraq Visa, Iraq tourist visa for indian, apply for Iraq e visa, Iraq e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Iraq visa for Indians. Indian passport holders can easily apply for an Iraq visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Iraq visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Iraq.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/iraq-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/iraq-visa-online");
  }
