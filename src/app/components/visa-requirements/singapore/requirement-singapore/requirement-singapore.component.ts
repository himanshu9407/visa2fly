...
@Component({
  selector: "app-requirement-singapore",
  templateUrl: "./requirement-singapore.component.html",
  styleUrls: ["./requirement-singapore.component.css"],
  animations: [
...
export class RequirementSingaporeComponent implements OnInit, AfterViewInit {
