...
@Component({
  selector: 'app-quotation-singapore',
  templateUrl: './quotation-singapore.component.html',
  styleUrls: ['./quotation-singapore.component.css']
})
export class QuotationSingaporeComponent implements OnInit {
