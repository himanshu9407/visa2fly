...
@Component({
  selector: 'app-requirments-qatar',
  templateUrl: './requirments-qatar.component.html',
  styleUrls: ['./requirments-qatar.component.css'],
  animations: [
...
export class RequirmentsQatarComponent implements OnInit, AfterViewInit {
