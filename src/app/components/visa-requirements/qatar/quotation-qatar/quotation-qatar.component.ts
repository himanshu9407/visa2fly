...
@Component({
  selector: 'app-quotation-qatar',
  templateUrl: './quotation-qatar.component.html',
  styleUrls: ['./quotation-qatar.component.css']
})
export class QuotationQatarComponent implements OnInit {
  @Input() quotation;
