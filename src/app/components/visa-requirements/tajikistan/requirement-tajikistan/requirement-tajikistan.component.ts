...
@Component({
  selector: 'app-requirement-tajikistan',
  templateUrl: './requirement-tajikistan.component.html',
  styleUrls: ['./requirement-tajikistan.component.css'],
  animations: [
...
export class RequirementTajikistanComponent implements OnInit {
