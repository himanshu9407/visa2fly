...
export class TajikistanComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/tajikistan-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/tajikistan-visa-online");
