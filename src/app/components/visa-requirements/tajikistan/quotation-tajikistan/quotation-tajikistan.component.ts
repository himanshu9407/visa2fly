...
@Component({
  selector: 'app-quotation-tajikistan',
  templateUrl: './quotation-tajikistan.component.html',
  styleUrls: ['./quotation-tajikistan.component.css']
})
export class QuotationTajikistanComponent implements OnInit {
