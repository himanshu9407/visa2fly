...
@Component({
  selector: "app-requirement-maldives",
  templateUrl: "./requirement-maldives.component.html",
  styleUrls: ["./requirement-maldives.component.css"],
  animations: [
...
export class RequirementMaldivesComponent implements OnInit, AfterViewInit {
