...
@Component({
  selector: 'app-requirement-uganda',
  templateUrl: './requirement-uganda.component.html',
  styleUrls: ['./requirement-uganda.component.css'],
  animations: [
...
export class RequirementUgandaComponent implements OnInit {
