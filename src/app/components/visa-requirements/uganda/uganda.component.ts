...
export class UgandaComponent implements OnInit {
  ...
  public selectedCountrytype = "Uganda";
  ...
  constructor(
    ...
    this.activatedRoute.params.subscribe((params) => {
      if (params["purpose"]) {
        this.router.navigate(["visa", "uganda-visa-online"]);
      }
    });
   ...
   ngOnInit() {
    ...
    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for uganda e-visa, uganda tourist visa application, uganda tourist visa for indian, apply for uganda e visa, uganda e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Planning to visit Uganda? Apply your Uganda e-visa online at Visa2Fly to make experience a hassle-free and convenient experience. Visa2Fly offers a swifter visa process with additional benefits like travel insurance and travel sim cards. Know more.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Uganda.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
