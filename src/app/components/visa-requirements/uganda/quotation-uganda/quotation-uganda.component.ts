...
@Component({
  selector: 'app-quotation-uganda',
  templateUrl: './quotation-uganda.component.html',
  styleUrls: ['./quotation-uganda.component.css']
})
export class QuotationUgandaComponent implements OnInit {
  @Input() quotation;
