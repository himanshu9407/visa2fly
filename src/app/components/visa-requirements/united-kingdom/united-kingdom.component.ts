...
export class UnitedKingdomComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for UK e-visa, UK tourist visa application, UK tourist visa for Indian, apply for UK e visa, UK e-visa for Indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
    ...
    this.meta.updateTag({
      property: "og:title",
      content:
        "UK Visa | Apply For UK Visa Online for Indians- Visa2Fly",
    });
    this.meta.updateTag({ property: "type", content: "website" });
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/United Kingdom.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
