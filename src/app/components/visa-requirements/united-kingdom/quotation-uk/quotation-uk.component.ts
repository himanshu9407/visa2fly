...
@Component({
  selector: 'app-quotation-uk',
  templateUrl: './quotation-uk.component.html',
  styleUrls: ['./quotation-uk.component.css']
})
export class QuotationUkComponent implements OnInit {
