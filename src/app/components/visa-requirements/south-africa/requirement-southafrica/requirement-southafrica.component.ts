...
@Component({
  selector: "app-requirement-southafrica",
  templateUrl: "./requirement-southafrica.component.html",
  styleUrls: ["./requirement-southafrica.component.css"],
  animations: [
...
export class RequirementSouthafricaComponent implements OnInit, AfterViewInit {
