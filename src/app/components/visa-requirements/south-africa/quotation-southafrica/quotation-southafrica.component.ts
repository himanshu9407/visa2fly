...
@Component({
  selector: 'app-quotation-southafrica',
  templateUrl: './quotation-southafrica.component.html',
  styleUrls: ['./quotation-southafrica.component.css']
})
export class QuotationSouthafricaComponent implements OnInit {
