...
@Component({
  selector: 'app-quotation-switzerland',
  templateUrl: './quotation-switzerland.component.html',
  styleUrls: ['./quotation-switzerland.component.css']
})
export class QuotationSwitzerlandComponent implements OnInit {
