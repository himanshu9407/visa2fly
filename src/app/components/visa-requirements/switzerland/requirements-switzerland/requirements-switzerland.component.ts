...
@Component({
  selector: "app-requirements-switzerland",
  templateUrl: "./requirements-switzerland.component.html",
  styleUrls: ["./requirements-switzerland.component.css"],
  animations: [
...
export class RequirementsSwitzerlandComponent implements OnInit, AfterViewInit {
