...
@Component({
  selector: 'app-quotation-usa',
  templateUrl: './quotation-usa.component.html',
  styleUrls: ['./quotation-usa.component.css']
})
export class QuotationUsaComponent implements OnInit {
