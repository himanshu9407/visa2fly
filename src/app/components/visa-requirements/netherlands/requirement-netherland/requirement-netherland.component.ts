...
@Component({
  selector: "app-requirement-netherland",
  templateUrl: "./requirement-netherland.component.html",
  styleUrls: ["./requirement-netherland.component.css"],
  animations: [
...
export class RequirementNetherlandComponent implements OnInit, AfterViewInit {
