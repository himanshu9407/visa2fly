...
@Component({
  selector: 'app-quotation-netherland',
  templateUrl: './quotation-netherland.component.html',
  styleUrls: ['./quotation-netherland.component.css']
})
export class QuotationNetherlandComponent implements OnInit {
