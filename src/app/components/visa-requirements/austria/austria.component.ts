...
export class AustriaComponent implements OnInit {
  ...
  public selectedCountrytype = "Austria";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Austria Visa | Apply For Austria Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for austria e-visa, austria tourist visa application, Austria Visa, austria tourist visa for indian, apply for austria e visa, austria e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Austria visa for Indians. Indian passport holders can easily apply for an Austria visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Austria visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Austria.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/austria-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/austria-visa-online");
  }
