...
@Component({
  selector: 'app-quotation-myanmar',
  templateUrl: './quotation-myanmar.component.html',
  styleUrls: ['./quotation-myanmar.component.css']
})
export class QuotationMyanmarComponent implements OnInit {
