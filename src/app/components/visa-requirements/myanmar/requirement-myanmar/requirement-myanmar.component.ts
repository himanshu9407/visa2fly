...
@Component({
  selector: 'app-requirement-myanmar',
  templateUrl: './requirement-myanmar.component.html',
  styleUrls: ['./requirement-myanmar.component.css'],
  animations: [
...
export class RequirementMyanmarComponent implements OnInit {
