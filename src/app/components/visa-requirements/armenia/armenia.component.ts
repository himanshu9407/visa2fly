...
@Component({
  ...
  styleUrls: ['./armenia.component.css'],
  animations: [
...
export class ArmeniaComponent implements OnInit, AfterViewInit {
  ...
  public selectedCountrytype = "Armenia";
  ...
  constructor(private activeRoute: ActivatedRoute,
    ...
    @Inject(DOCUMENT) private doc) {
     ...
     ngOnInit() {
      this.titleService.setTitle("Armenia Visa | Apply For Armenia Visa Online for Indians- Visa2Fly");
      ...
      this.meta.updateTag({
        property: "og:title",
        content:
          "Armenia Visa | Apply For Armenia Visa Online for Indians- Visa2Fly",
      });
      this.meta.updateTag({ property: "type", content: "website" });
      this.meta.updateTag({
        property: "og:image",
        content: "https://static.visa2fly.com/country/Armenia.jpg",
      });
      this.meta.updateTag({
        property: "og:url",
        content: "https://visa2fly.com/visa/armenia-visa-online",
      });
      this.meta.updateTag({
      ...
      link.setAttribute("href", "https://visa2fly.com/visa/armenia-visa-online");
    }
