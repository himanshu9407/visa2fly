...
@Component({
  selector: 'app-quotation-zambia',
  templateUrl: './quotation-zambia.component.html',
  styleUrls: ['./quotation-zambia.component.css']
})
export class QuotationZambiaComponent implements OnInit {
