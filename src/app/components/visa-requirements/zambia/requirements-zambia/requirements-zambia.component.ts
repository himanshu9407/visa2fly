...
@Component({
  selector: 'app-requirements-zambia',
  templateUrl: './requirements-zambia.component.html',
  styleUrls: ['./requirements-zambia.component.css'],
  animations: [
...
export class RequirementsZambiaComponent implements OnInit, AfterViewInit {
