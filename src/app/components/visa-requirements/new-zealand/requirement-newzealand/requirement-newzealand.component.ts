...
@Component({
  selector: "app-requirement-newzealand",
  templateUrl: "./requirement-newzealand.component.html",
  styleUrls: ["./requirement-newzealand.component.css"],
  animations: [
...
export class RequirementNewzealandComponent implements OnInit, AfterViewInit {
