...
@Component({
  selector: 'app-quotation-newzealand',
  templateUrl: './quotation-newzealand.component.html',
  styleUrls: ['./quotation-newzealand.component.css']
})
export class QuotationNewzealandComponent implements OnInit {
