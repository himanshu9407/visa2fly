...
exports.NewZealandComponent = void 0;
var core_1 = require("@angular/core");
var forms_1 = require("@angular/forms");
var animations_1 = require("@angular/animations");
var common_1 = require("@angular/common");
var rxjs_1 = require("rxjs");
var NewZealandComponent = /** @class */ (function () {
    function NewZealandComponent(router, requireQuotation, userFlow, toastr, preloaderService, titleService, meta, activatedRoute, doc, platformId) {
        var _this = this;
        this.router = router;
        ...
        this.selectedCountrytype = "New Zealand";
        this.imageCatogory = [];
        ...
        this.activatedRoute.params.subscribe(function (params) {
            if (params["purpose"]) {
                _this.router.navigate(["visa", "australia-visa-online"]);
            }
        });
    ...
    NewZealandComponent.prototype.ngOnInit = function () {
        this.titleService.setTitle("New Zealand Visa | Apply For New Zealand Visa Online for Indians- Visa2Fly");
        this.meta.updateTag({
            name: "keywords",
            content: "apply for new zealand e-visa, new zealand tourist visa application, New Zealand Visa, new zealand tourist visa for indian, apply for new zealand e visa, new zealand e-visa for indians"
        });
        this.meta.updateTag({
            name: "description",
            content: "Visa2fly offers New Zealand visa for Indians. Indian passport holders can easily apply for a New Zealand visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their New Zealand visa online with Visa2Fly here."
        });
        // facebook and linkedin
        this.meta.updateTag({
            property: "og:title",
            content: "New Zealand Visa | Apply For New Zealand Visa Online for Indians- Visa2Fly"
        });
        ...
        link.setAttribute("href", "https://visa2fly.com/visa/new-zealand-visa-online");
    };
    NewZealandComponent.prototype.purposeChanged = function () {
    ...
    NewZealandComponent.prototype.navigateTo = function (purpose) {
    ...
    NewZealandComponent = __decorate([
        core_1.Component({
    ...
    return NewZealandComponent;
}());
exports.NewZealandComponent = NewZealandComponent;
