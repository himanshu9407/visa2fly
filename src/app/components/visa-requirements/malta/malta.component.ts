...
@Component({
  selector: 'app-malta',
  templateUrl: './malta.component.html',
  styleUrls: ['./malta.component.css'],
  animations: [
...
export class MaltaComponent implements OnInit {
  ngbTabTitleClass;
  ...
  public selectedCountrytype = "Malta";
  ...
  ngOnInit() {
    this.titleService.setTitle(
      "Malta Visa | Apply For Malta Visa Online for Indians- Visa2Fly"
    );

    this.meta.updateTag({
      name: "keywords",
      content:
        "apply for Malta e-visa, Malta tourist visa application, Malta Visa, Malta tourist visa for indian, apply for Malta e visa, Malta e-visa for indians",
    });
    this.meta.updateTag({
      name: "description",
      content:
        "Visa2fly offers Malta visa for Indians. Indian passport holders can easily apply for an Malta visa online at Visa2Fly. Visa2fly offers doorstep visa services making it convenient for Indian nationals. Indian nationals can fill their Malta visa online with Visa2Fly here.",
    });
    ...
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Malta.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
