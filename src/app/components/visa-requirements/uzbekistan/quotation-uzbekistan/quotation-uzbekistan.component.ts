...
@Component({
  selector: 'app-quotation-uzbekistan',
  templateUrl: './quotation-uzbekistan.component.html',
  styleUrls: ['./quotation-uzbekistan.component.css']
})
export class QuotationUzbekistanComponent implements OnInit {
