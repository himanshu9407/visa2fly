...
@Component({
  selector: 'app-quotation-spain',
  templateUrl: './quotation-spain.component.html',
  styleUrls: ['./quotation-spain.component.css']
})
export class QuotationSpainComponent implements OnInit {
