...
export class SpainComponent implements OnInit, AfterViewInit  {
  ...
  ngOnInit() {
    ...
    link.setAttribute("href", "https://visa2fly.com/visa-requirements/apply-for-Spain-visa-online/Tourist");
  }
  ...
  purposeChanged() {
    ...
    window.history.replaceState(
      "",
      "",
      "/visa-requirements/apply-for-Spain-visa-online/" + purpose
    );
    // console.log(this.businessArr);
  ...
  navigateTo(purpose: any) {
    ...
    window.history.replaceState(
      "",
      "",
      "/visa-requirements/apply-for-Spain-visa-online/" + purposeUrl
    );
