...
@Component({
  selector: "app-requirement-ukraine",
  templateUrl: "./requirement-ukraine.component.html",
  styleUrls: ["./requirement-ukraine.component.css"],
  animations: [
...
export class RequirementUkraineComponent implements OnInit, AfterViewInit {
