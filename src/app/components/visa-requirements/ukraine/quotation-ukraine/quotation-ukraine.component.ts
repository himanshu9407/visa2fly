...
@Component({
  selector: 'app-quotation-ukraine',
  templateUrl: './quotation-ukraine.component.html',
  styleUrls: ['./quotation-ukraine.component.css']
})
export class QuotationUkraineComponent implements OnInit {
