...
export class EgyptComponent implements OnInit, AfterViewInit {
  ...
  public selectedCountrytype = "Egypt";
  ...
  constructor(
   ...
   ngOnInit() {
    this.titleService.setTitle("Egypt Visa | Apply For Egypt Visa Online for Indians- Visa2Fly");
    ...
    this.meta.updateTag({
      property: "og:title",
      content:
        "Egypt Visa | Apply For Egypt Visa Online for Indians- Visa2Fly",
    });
    this.meta.updateTag({ property: "type", content: "website" });
    this.meta.updateTag({
      property: "og:image",
      content: "https://static.visa2fly.com/country/Egypt.jpg",
    });
    this.meta.updateTag({
      property: "og:url",
      content: "https://visa2fly.com/visa/egypt-visa-online",
    });
    this.meta.updateTag({
    ...
    link.setAttribute("href", "https://visa2fly.com/visa/egypt-visa-online");
  }
