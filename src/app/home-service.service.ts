...
export class HomeServiceService {
  ...
  getHomelanding() {
    return this.http.get('https://jsonplaceholder.typicode.com/users',{headers: new HttpHeaders().set('Content-Type', 'application/x-www-form-urlencoded'), observe: "response"})
